...
public:
  ...
  void RasterizeGridTriangleSetValue(const R2Point& p1, const R2Point& p2, const R2Point& p3, RNScalar value);
  void RasterizeGridTriangleSetValue(const int p1[3], const int p2[3], const int p3[3], RNScalar value1, RNScalar value2, RNScalar value3);
  void RasterizeGridTriangleSetValue(const R2Point& p1, const R2Point& p2, const R2Point& p3, RNScalar value1, RNScalar value2, RNScalar value3);
...
inline void R2Grid::
RasterizeGridTriangleSetValue(const R2Point& p1, const R2Point& p2, const R2Point& p3, RNScalar value1, RNScalar value2, RNScalar value3)
{
  // Splat value everywhere inside grid triangle
  int i1[2] = { (int) (p1[0] + 0.5), (int) (p1[1] + 0.5) };
  int i2[2] = { (int) (p2[0] + 0.5), (int) (p2[1] + 0.5) };
  int i3[2] = { (int) (p3[0] + 0.5), (int) (p3[1] + 0.5) };
  RasterizeGridTriangleSetValue(i1, i2, i3, value1, value2, value3);
}



inline void R2Grid::
RasterizeGridTriangleSetValue(const R2Point& p1, const R2Point& p2, const R2Point& p3, RNScalar value)
{
  // Splat value everywhere inside world triangle
  RasterizeGridTriangleSetValue(p1, p2, p3, value, value, value);
}
