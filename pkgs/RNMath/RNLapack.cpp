// Source file for Lapack wrapper code
...
int RNSolveLinearSystem(double *A, double *x, double *b, int n, int nrhs)
{
...
int RNSolveLeastSquares(double *A, double *x, double *b, int m, int n, int nrhs)
{
  // Allocate temporary memory
  char trans = 'N';
  int info; 
