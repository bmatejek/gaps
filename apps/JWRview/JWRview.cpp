...
static long downsample_resolution[3] = { 120, 128, 128 };
...
ReadSkeletonData(void)
{
    ...
    sprintf(input_filename, "skeletons/%s/thinning-%03ldx%03ldx%03ld-upsample-00-skeleton.pts", prefix, downsample_resolution[IB_X], downsample_resolution[IB_Y], downsample_resolution[IB_Z]);
...
{
    std::vector<long> *skeletons = thinning_skeletons;
